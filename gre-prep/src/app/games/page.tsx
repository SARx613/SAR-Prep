  ...
  return (
    <main style={{ minHeight: '100vh', paddingTop: '2rem', paddingBottom: '6rem', position: 'relative' }}>
      ...
      <div className="page-shell">
        ...
        {/* Header */}
        <header className="game-header" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '1rem', flexWrap: 'wrap', marginBottom: '2.5rem' }} >
          ...
          <div className="game-header-left" style={{ display: 'flex', alignItems: 'center', gap: '0.85rem', minWidth: 0 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', minWidth: 0 }}>
              <BrainCircuit size={22} color="var(--emerald)" style={{ flexShrink: 0 }} />
              <span style={{ fontWeight: 800, fontSize: '1.05rem', color: '#fff', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>S&apos;entraîner</span>
            </div>
          </div>
          ...
          {/* Queue counter */}
          {progress && (
            <div className="glass" style={{ display: 'flex', alignItems: 'center', gap: '0.65rem', padding: '0.5rem 1.15rem', borderRadius: 99, whiteSpace: 'nowrap', flexShrink: 0 }}>
