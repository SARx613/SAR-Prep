  ...
  return (
    <main style={{ minHeight: '100vh', paddingTop: '2rem', paddingBottom: '6rem', position: 'relative' }}>
      ...
      <div className="page-shell">
        ...
        {/* Header */}
        <header style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '1rem', flexWrap: 'wrap', marginBottom: '2.5rem' }} className="animate-fade-up game-header">
          ...
          <div className="game-header-left" style={{ display: 'flex', alignItems: 'center', gap: '0.85rem', minWidth: 0 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', minWidth: 0 }}>
              ...
              <span style={{ fontWeight: 800, fontSize: '1.05rem', color: '#fff', whiteSpace: 'nowrap' }}>Flashcards</span>
            </div>
          </div>
